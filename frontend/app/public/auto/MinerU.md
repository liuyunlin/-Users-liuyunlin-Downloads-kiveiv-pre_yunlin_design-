...
Bin Wang∗, Chao $\mathbf { X u } _ { 9 } ^ { * }$ Xiaomeng Zhao, Linke Ouyang, Fan Wu, Zhiyuan Zhao, Rui Xu, Kaiwen Liu, Yuan Qu, Fukai Shang, Bo Zhang, Liqun Wei, Zhihao Sui, Wei Li, Botian Shi, Yu Qiao, Dahua Lin, Conghui He†
...
![](images/8d2afc09340ea47a43f6b5fffb58eb9647e4e007ecba28faf0c01d01037c3d1e.jpg)  
...
Document Preprocessing. This stage uses $\mathrm { P y M u P D F ^ { 4 } }$ to read PDF files, filter out unprocessable files (e.g., encrypted files), and extract PDF metadata, including the document’s parseability (categorized into parseable and scanned PDFs), language type, and page dimensions.
...
![](images/f5299b7203bb76d539b5a186c8077fe8bbef501bb648780222704fb43a7584f0.jpg)  
...
![](images/b85ea9ee310391da1a9c0ac94d12cbcf8ebdbe5fff14baaf65829a06a284a514.jpg)  
...
![](images/838e7de2874c3a900e7095cea04b199908bf76c73c074de874df512817557d06.jpg)  
...
![](images/84831ce4c4f8dbcba930bf9c50a81d842df959d55eca93e8b70514872ab6a78b.jpg)
...
Leibniz Institute for Prevention Researchand Epidemiology-BlPSand University of Bremen

Marvin N.Wright, Norman Wirsik,and Mirko Brandes Leibniz Institute for Prevention Researchand Epidemiology-BIPS

Purpose:Study purposes were todevelopenergy expenditure(EE)predictionmodelsfromrawaccelerometer dataand to investigatetepeformaneoftheediferentaccelerometersonfivediferentwearpositionsinpreschoolersMethdsFourtyone children $54 \%$ boys;3-6.3years)woretwoActigraphGT3X(leftandrighthip)，threeGENEActiv(righthipleftandrightwrist) andoneactiALrighttigh）whilecompletigasemstructuredprotoolof10ageapropriateactivitiesarticipantsore portableindirectcalorimetertoestimateEE.UtilizedmodelstoestimateEEincludedalinearmodel(LM)amixedlinarmodel (MLM)sellalkelcheleeel positionweasessdpredctionaccuracyvialeaveooutrossaliationandcallatedthomean-suaedrorE) Results:MeanRMSErangedfrom2.56-2.76JinfortheRF,2.72-3.08kJminfortheANN2.83-2.94infortheLnd 2.81-2.92JminfortheMLM.TheGENEActiveobtainedmeanRMSEf2.56Jmin(leftandrightwristand2.73Jmin(ight hip).PredictingEEusingtheGT3XontheleftandrighthipobtainedmeanRMSEof2.60and2.74kJ/min.TheactivPALobtaineda meanRMSEof2.76J/min.Concusion:Teseresultsdemonstrategoodpredictionaccuracyforecentacelerometersodient wearpositionsinpreschoolersTheRFandANNwereequallaccurateinEEpredictioncomparedwith(mixed)linearmodels.The RFseemstobeaviablealternativetolinearandANNmodelsforEEpredictioninyoungchildreninasemi-structuredeting

Keywordselerometerieniaredelcineingicaliityii

2Itis generally agreed that regular physical activity (PA)is related to important health outcomes in children (e.g.,cardiometabolicand psychosocial health;Knaeps etal.,2O18;Reddon,Meyre, &Cairney，2O17;Shoup，Gattshall,Dandamudi，& Estabrooks 2008:Skrede etal.,2017;Wafa ct al.,2016).PAisdefined as any bodily movement produced by skeletal muscles that resultsin energy expenditure (EE)(Caspersen，Powell，& Christenson, 1985).In order to monitor children's PA,analyzeassociations between PA and health outcomes,and evaluate the effectiveness of interventions promoting PA among children,valid measures of children'sPAandEEareneeded(Lamonte&Ainsworth,2001).In recent years,accelerometers have gained considerable popularity as an objective measure of sedentary behaviors,PA and other outcomes,such as EE.They detect accelerations of the body and enableanitioftesityequencyationdtye ofmovement（Hlls，ta&e,;ote, Kristiansen,Hanisch,&Holtermann,2O14).Accelerometers have several advantages over traditional questionnaire-based measures ofPA,incspeeilityityndes ingly being used instudies with very youngchildren (Hills et al. 2014).However,traditional linearmodelcquations developed for activity count-based datado not provide accurate estimates of EE in preschoolers (Janssen et al.,2ol3;Reilly et al.,2006).

Steenbock,Wright,Wirsik,and Brandes are with the Leibniz Institute for Prevention Research and Epidemiology-BIPS,Bremen,Germany.Steenbock is with theCenter ofClinical PsychologyandRehabilitation，University of Bremen,Bremen. Germany.Steecksc@lsde)isrespod

3 Because the relationships between accelerometer output and EEdiffer in preschoolers compared with older children,prediction equations require development and validation in thisspecificage group(Butte ct al.,2014).Considerable progresshas been made inpredicting EE foradultsand older children Jimmy，Seiler& Maeder，2O13Montoye，Begum，Henning，& Pfeiffer，2017； Montoye,uddiswas&feiffer，215hereassvral methodological questions concerning the use of accelerometry in young children remain open.In their recently published review that provides age-specific practical considerations on accelerome terdata collection(e.g.,deviceplacement)and processing criteria (e.g.,epoch length，cut-points,and algorithms)，Miguelesand colleagues(2o17)observed a lack of calibration and validation studies for preschoolers that address important processing criteria （such as EE algorithms for wrist-and hip-worn accelerometers) However,as studies included inthereview wererestrictedtothose applying the latest version of the Actigraph device (GT3X)，no practical consideration about device selection in this age group could be drawn.Besides this,most of the research on EE prediction that has been done in preschoolers is limited by the use of direct observation as the criterion measurement and theassignment of fixedmetabolicequivalents(METs)toactivities and accelerometer output(Daviesetal.,2012;DeDeckeretal.2013;Hagenbuchner Cliff,Trost,Van Tuc&oples25).Additionallyeuseo highly structured protocols under laboratory setings has been found to overestimate EE in children,which limits the transfer to free-living behaviors (Nilsson et al.,2008)

Recent studies in older children and adults show improvements in EE prediction using non-lincar models (Mackintosh
...
![](images/f443b0b9045e3cb8b0a8f85dd6f3f1e4019310d9f5f758e1bf5f56261c566a55.jpg)  
